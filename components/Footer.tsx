...
function Column({
  ...
  return (
    <div>
      <h3 className="font-display text-lg tracking-wide text-next-text">{title}</h3>
...
export function Footer() {
  return (
    <footer className="relative mt-auto bg-next-footer text-next-text">
      <div
        className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-next-secondary to-transparent shadow-[0_0_12px_rgba(0,229,204,0.65)]"
        aria-hidden
      />
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="mb-12 flex flex-col gap-8 border-b border-next-border pb-12 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm text-next-text-secondary">
              New Era Xceptional Talent — Afrogospel competition and incubator lifting the next wave of voices.
            </p>
          </div>
          <div className="grid flex-1 grid-cols-2 gap-8 sm:grid-cols-4 lg:max-w-3xl">
            <Column title="Quick Links" links={quickLinks} />
            <Column title="For Artists" links={forArtists} />
            <Column title="For Fans" links={forFans} />
            <div>
              <h3 className="font-display text-lg tracking-wide text-next-text">Connect</h3>
              <p className="mt-4 text-sm text-next-text-secondary">
                Follow Energize Music and NEXT for auditions, drops, and tour news.
              </p>
